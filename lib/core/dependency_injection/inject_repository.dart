...
import 'package:e_con/src/data/repositories/final_exam_student_repository_impl.dart';
...
void injectRepository(GetIt locator) {
  ...
  locator.registerLazySingleton<FinalExamStudentRepository>(
    () => FinalExamStudentRepositoryImpl(
      finalExamStudentDatasource: locator(),
    ),
  );
}
