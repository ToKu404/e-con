...
class LecturerListSeminarPage extends StatefulWidget {
  const LecturerListSeminarPage({super.key});

  @override
  State<LecturerListSeminarPage> createState() =>
      _LecturerListSeminarPageState();
}
