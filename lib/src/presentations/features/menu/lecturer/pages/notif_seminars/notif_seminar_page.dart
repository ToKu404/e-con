...
class _LecturerNotifCard extends StatefulWidget {
  ...
  @override
  State<_LecturerNotifCard> createState() => _LecturerNotifCardState();
}

class _LecturerNotifCardState extends State<_LecturerNotifCard> {
  @override
  void initState() {
    Future.microtask(() => context.read<GetUserNotifier>()..getCredential());
    super.initState();
  }
      ...
      return Padding(
        ...
        child: InkWell(
          onTap: () {
            ...
            Navigator.pushNamed(context, AppRoutes.cplWebview, arguments: {
              'credential': data,
            });
          },
          child: Container(
                      ...
                      if (widget.notif.createdAt != null)
                        Text(
                          ReusableFunctionHelper.datetimeToString(
                              widget.notif.createdAt!,
                              format: widget.notif.createdAt!.day ==
                                      DateTime.now().day
                                  ? 'HH:mm dd MMM'
                                  : 'dd MMM'),
