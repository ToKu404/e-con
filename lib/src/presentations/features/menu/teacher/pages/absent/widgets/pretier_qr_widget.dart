...
class PrettyQrCodePainter extends CustomPainter {
  ...
  void _paintRound(Canvas canvas, Size size) {
    ...
    final double pixelSize = size.width / _qrImage.moduleCount;
  ...
  void _setShapeInner(
    ...
    final double widthY = pixelSize * (y - 1);
    final double heightX = pixelSize * (x - 1);

    //bottom right check
    if (matrix[y + 1][x] && matrix[y][x + 1] && matrix[y + 1][x + 1]) {
      final Offset p1 =
          Offset(heightX + pixelSize - (0.25 * pixelSize), widthY + pixelSize);
      final Offset p2 = Offset(heightX + pixelSize, widthY + pixelSize);
      final Offset p3 =
    ...
    //top left check
    if (matrix[y - 1][x] && matrix[y][x - 1] && matrix[y - 1][x - 1]) {
      final Offset p1 = Offset(heightX, widthY + (0.25 * pixelSize));
      final Offset p2 = Offset(heightX, widthY);
      final Offset p3 = Offset(heightX + (0.25 * pixelSize), widthY);
    ...
    if (matrix[y + 1][x] && matrix[y][x - 1] && matrix[y + 1][x - 1]) {
      final Offset p1 =
          Offset(heightX, widthY + pixelSize - (0.25 * pixelSize));
      final Offset p2 = Offset(heightX, widthY + pixelSize);
      final Offset p3 =
          Offset(heightX + (0.25 * pixelSize), widthY + pixelSize);
    ...
    if (matrix[y - 1][x] && matrix[y][x + 1] && matrix[y - 1][x + 1]) {
      final Offset p1 =
          Offset(heightX + pixelSize - (0.25 * pixelSize), widthY);
      final Offset p2 = Offset(heightX + pixelSize, widthY);
      final Offset p3 =
          Offset(heightX + pixelSize, widthY + (0.25 * pixelSize));
